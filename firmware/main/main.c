...
static void mqtt5_app_start(void) {
  ...
  /* If you call esp_mqtt5_client_set_user_property to set user properties, DO NOT forget to delete
   * them. esp_mqtt5_client_set_connect_property will malloc buffer to store the user_property and
